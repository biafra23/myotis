...
private fun NodeService.Snapshot.toModel(): NodeSnapshot = NodeSnapshot(
    ...
    peerHeaderRequests = peerHeaderRequests(),
    peerHeaderRequestsServed = peerHeaderRequestsServed(),
    peerBodyRequests = peerBodyRequests(),
    peerBodyRequestsServed = peerBodyRequestsServed(),
